...
final class StringKeyDataBuilder implements BuildsKeyData
{
	...
	{
		return !$keyName->hasSubKey() && (KeyType::STRING === $keyInfo->getType());
	}
	...
	{
		$rawKeyData = $this->manager->getValue( $keyName->getKeyName() ) ?: '';
